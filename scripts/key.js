...
function generateKey(){
    ...
    if (name == ""){
        document.getElementById("key").innernHTML = "Errors occurred during key generation:<br> * name cannot be empty";
        return;
    }
    ...
    if (name.startsWith("dev")){
        ...
        document.getElementById("key").innerHTML = "Success! Your key is (DO NOT SHARE!): <br>" + key + "<br>Copied to clipboard.";
